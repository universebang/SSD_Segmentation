...
def build_model(image_size,
    ...
    '''
    conv1_1 = Conv2D(64, (3, 3), activation='relu', padding='same', name='block1_conv1', data_format='channels_last')(x1)
    ...
    # Block 4
    conv3_1_add = Conv2D(512, (3, 3), activation='relu', padding='same', name='block4_conv1')(conv3_3)
    conv3_1_add = Dropout(0.5, name='dr1')(conv3_1_add)
    conv3_2_add = Conv2D(512, (3, 3), activation='relu', padding='same', name='block4_conv2')(conv3_1_add)
    conv3_2_add = Dropout(0.5, name='dr2')(conv3_2_add)
    conv3_3_add = Conv2D(512, (3, 3), activation='relu', padding='same', name='block4_conv3')(conv3_2_add)
    conv3_3_add = Dropout(0.5, name='dr3')(conv3_3_add)
    ...
    anchors3_3_add = AnchorBoxes(img_height, img_width, this_scale=scales[1], next_scale=scales[2], aspect_ratios=aspect_ratios[1],
                                    two_boxes_for_ar1=two_boxes_for_ar1, this_steps=steps[1], this_offsets=offsets[1], clip_boxes=clip_boxes,
                                    variances=variances, coords=coords, normalize_coords=normalize_coords, name='anchors3_3_add')(boxes3_3_add)
    anchors4 = AnchorBoxes(img_height, img_width, this_scale=scales[2], next_scale=scales[3], aspect_ratios=aspect_ratios[2],
                                        two_boxes_for_ar1=two_boxes_for_ar1, this_steps=steps[2], this_offsets=offsets[2], clip_boxes=clip_boxes,
                                        variances=variances, coords=coords, normalize_coords=normalize_coords, name='anchors4')(boxes4)
    anchors5 = AnchorBoxes(img_height, img_width, this_scale=scales[3], next_scale=scales[4], aspect_ratios=aspect_ratios[3],
                                        two_boxes_for_ar1=two_boxes_for_ar1, this_steps=steps[3], this_offsets=offsets[3], clip_boxes=clip_boxes,
                                        variances=variances, coords=coords, normalize_coords=normalize_coords, name='anchors5')(boxes5)
    anchors6 = AnchorBoxes(img_height, img_width, this_scale=scales[4], next_scale=scales[5], aspect_ratios=aspect_ratios[4],
                                        two_boxes_for_ar1=two_boxes_for_ar1, this_steps=steps[4], this_offsets=offsets[4], clip_boxes=clip_boxes,
                                        variances=variances, coords=coords, normalize_coords=normalize_coords, name='anchors6')(boxes6)
    anchors7 = AnchorBoxes(img_height, img_width, this_scale=scales[5], next_scale=scales[6], aspect_ratios=aspect_ratios[5],
    ...
    classes_concat = Concatenate(axis=1, name='classes_concat')([classes3_3_reshaped,
                                                                 classes3_3_add_reshaped,
                                                                 classes4_reshaped,
                                                                 classes5_reshaped,
                                                                 classes6_reshaped,
                                                                 classes7_reshaped])
    ...
    boxes_concat = Concatenate(axis=1, name='boxes_concat')([boxes3_3_reshaped,
                                                             boxes3_3_add_reshaped,
                                                             boxes4_reshaped,
                                                             boxes5_reshaped,
                                                             boxes6_reshaped,
                                                             boxes7_reshaped])
    ...
    anchors_concat = Concatenate(axis=1, name='anchors_concat')([anchors3_3_reshaped,
                                                                 anchors3_3_add_reshaped,
                                                                 anchors4_reshaped,
                                                                 anchors5_reshaped,
                                                                 anchors6_reshaped,
                                                                 anchors7_reshaped])
...
def init_Model():
    ...
    model.load_weights(r'C:/code/python/ssd_keras-master-copy/weight_base_line/ssd7_epoch-03_loss-2.3741_val_loss-2.3561.h5', by_name=True)

    # add: freeze some layer
    freeze_layers = ['identity_layer', 'input_mean_normalization', 'input_stddev_normalization', 'conv1_1', 'conv1_2', 'pool1',
                     'conv2_1', 'conv2_2', 'pool2', 'conv3_1', 'conv3_2', 'conv3_3']
